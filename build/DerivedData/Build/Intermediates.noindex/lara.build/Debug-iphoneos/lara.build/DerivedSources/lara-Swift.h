...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC4lara33SantanderFileReaderViewController")
@interface SantanderFileReaderViewController : UIViewController <QLPreviewControllerDataSource, UISearchBarDelegate, UISearchResultsUpdating>
...
@class NSURL;
SWIFT_CLASS("_TtC4lara31SantanderPathListViewController")
@interface SantanderPathListViewController : UITableViewController <UIDocumentPickerDelegate, UISearchBarDelegate, UISearchResultsUpdating>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
...
@class UTType;
@interface UIDocumentPickerViewController (SWIFT_EXTENSION(lara))
- (UIDocumentPickerViewController * _Nonnull)fix_initForOpeningContentTypes:(NSArray<UTType *> * _Nonnull)contentTypes asCopy:(BOOL)asCopy SWIFT_WARN_UNUSED_RESULT;
@end
